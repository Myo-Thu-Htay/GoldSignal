...
class _TrendWidgetState extends ConsumerState<TrendWidget> {
  ...
  double _calculateYPosition(
    ...
    final height = MediaQuery.of(context).size.height *
        0.3; // adjust based on your chart height
  ...
  Widget build(BuildContext context) {
    ...
    final sortedTrend =
        candles.length > 300 ? candles.sublist(candles.length - 300) : candles;
          ...
          child: Stack(
            children: [
              ...
              Positioned(
                right: 20,
                top:
                    _calculateYPosition(chartMin, chartMax, lastClose, context),
                child: Row(
                  children: [
                    Text("--"),
                    Container(
